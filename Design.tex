...
\begin{enumerate}
	...
	\item Для отрисовки воды используется аргумент \verb|water|, которые автоматически заливает фигуру голубым полупрозрачным цветом. Также есть предопределенные цвета для других заливок: \verb|gas|, \verb|glass|
