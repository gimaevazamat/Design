...
\begin{code}
	...
	\end{figure}
\end{code}
Этот кусок кода рисует отрезок соединяющий точки с координатами $(0,0)$ и $(0,2~\text{сm})$.
...
\begin{code}
	...
	\end{tikzpicture}
\end{code}
Также здесь продемонстрирован пример подписи объекта с использованием команды \verb|node|.
