...
Для начала надо скачать \verb|design.sty| файл в директорию вашего документа для использование наших предопределенных команд и стилей
...
Отрисовка экранов похожа на отрисовку недвижимости. Линия экрана рисуется толщиной \verb|ultra thick|
\begin{figure}[H]
\begin{minipage}{0.1\linewidth}
	\centering	
	\begin{tikzpicture}[example, >=latex']
		\draw[ultra thick] (0,0) -- (0, -5);
		\fill[screen] (0,0) rectangle (0.2, -5);
	\end{tikzpicture}
\end{minipage}
\begin{minipage}{0.9\linewidth}
	\begin{code}
...
Чтобы на рисунках можно было визуально различать зеркала и экраны предлагается использовать для зеркал шаблон, представленный ниже
\begin{figure}[H]
	\begin{minipage}{0.1\linewidth}
		\centering	
		\begin{tikzpicture}
			\draw[line width=3pt] (0,0) -- (0, -5);
			\draw[mirror] (0,0) rectangle (0.2, -5);
			
%			\draw[line width=3pt] (1,0) arc (23.6:-23.6:6);
			
%			\draw (1,0) arc[start angle=23.6, end angle=-23.6, radius=6.5];
%			\fill[mirror] (1,0) arc (23.6:-23.6:2) --++ (0,0) arc (-23.6:23.6:6.2);
